...
const PostLikesComments: React.FC<Props> = ({ likes = 0, comments = 0}) => {
    return (
        <div className="post-likes-comments-container">
            <div className="likes">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="likes-icon">
            ...
            <div className="comments">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="comments-icon">
